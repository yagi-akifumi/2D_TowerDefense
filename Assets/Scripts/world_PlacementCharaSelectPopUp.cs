...
public class world_PlacementCharaSelectPopUp : MonoBehaviour
{
    ...
    public void SetUpPlacementCharaSelectPopUp2(CharaGenerator charaGenerator)
    {
        ...
        // 各ボタンにメソッドを登録
        btnChooseChara.onClick.AddListener(OnClickSubmitChooseChara2);

        btnClosePopUp.onClick.AddListener(OnClickClosePopUp2);
    ...
    /// </summary>
    private void OnClickSubmitChooseChara2()
    {
    ...
    /// 配置を止めるボタンを押した際の処理
    /// </summary>
    private void OnClickClosePopUp2()
    {
