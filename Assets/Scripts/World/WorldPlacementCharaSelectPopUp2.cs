...
public class WorldPlacementCharaSelectPopUp2 : MonoBehaviour
{
    [SerializeField]
    ...
    public void WorldSetUpPlacementCharaSelectPopUp(CharaGenerator charaGenerator)
    {
        ...
        // 各ボタンの操作を押せない状態にする
        WorldSwithcActivateButtons(false);
        ...
        // 各ボタンにメソッドを登録
        btnChooseChara.onClick.AddListener(WorldOnClickSubmitChooseChara);

        btnClosePopUp.onClick.AddListener(WorldOnClickClosePopUp);

        // 各ボタンを押せる状態にする
        WorldSwithcActivateButtons(true);
    }
    ...
    public void WorldSwithcActivateButtons(bool isSwitch)
    {
    ...
    /// </summary>
    private void WorldOnClickSubmitChooseChara()
    {
    ...
    /// 配置を止めるボタンを押した際の処理
    /// </summary>
    private void WorldOnClickClosePopUp()
    {
